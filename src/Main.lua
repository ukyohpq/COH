...
local unit1 = UnitFactory:createUnitByTemplateId(101, 1)
local unit2 = UnitFactory:createUnitByTemplateId(101, 1)
local unit3 = UnitFactory:createUnitByTemplateId(102, 1)
local unit4 = UnitFactory:createUnitByTemplateId(103, 1)
local unit5 = UnitFactory:createUnitByTemplateId(101, 1)
